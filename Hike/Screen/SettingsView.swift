        ...
        List {
            ...
            Section {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("The hike which looks gorgeus in photos but is even better when you are actually there. The hike that you hope to do again someday. \nFind the best day hikes in the app.")
                        .font(.footnote)
                        .italic()
                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 12) {
                        ForEach(alternateAppIcons.indices, id: \.self) { item in
                            Button {
                                print("Icon was pressed \(alternateAppIcons[item])")
